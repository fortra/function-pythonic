...
def fromYaml(string, readOnly=None):
    return fromObject(yaml.safe_load(string), readOnly)

def fromJson(string, readOnly=None):
    return fromObject(json.loads(string), readOnly)

def fromObject(object, readOnly=None):
...
class _Dumper(yaml.SafeDumper):
    ...
    def represent_values(self, values):
        ...
        return self.represent_none(values)
